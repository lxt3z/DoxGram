...
private func SGControllerEntries(presentationData: PresentationData, callListSettings: CallListSettings, experimentalUISettings: ExperimentalUISettings, appConfiguration: AppConfiguration, nameColors: PeerNameColors, state: SGSettingsControllerState) -> [SGControllerEntry] {
    ...
    case 7:
        retentionText = lang.hasPrefix("ru") ? "7 дней" : "7 days"
    case 30:
        retentionText = lang.hasPrefix("ru") ? "30 дней" : "30 days"
    case 90:
        retentionText = lang.hasPrefix("ru") ? "90 дней" : "90 days"
    default:
...
//            }
            ...
            case .ayugramRetention:
                ...
                let options: [(Int, String)] = [
                    (7, presentationData.strings.baseLanguageCode.hasPrefix("ru") ? "7 дней" : "7 days"),
                    (30, presentationData.strings.baseLanguageCode.hasPrefix("ru") ? "30 дней" : "30 days"),
                    (90, presentationData.strings.baseLanguageCode.hasPrefix("ru") ? "90 дней" : "90 days"),
                    (0, presentationData.strings.baseLanguageCode.hasPrefix("ru") ? "Без ограничений" : "Unlimited")
                ]
    ...
    |> map { _, /*sliderValue,*/ state, presentationData, sharedData, view, contentSettingsConfiguration, availableReplyColors, availableProfileColors ->  (ItemListControllerState, (ItemListNodeState, Any)) in
        ...
        let controllerState = ItemListControllerState(presentationData: ItemListPresentationData(presentationData), title: .text("Aerogram"), leftNavigationButton: nil, rightNavigationButton: nil, backNavigationButton: ItemListBackButton(title: presentationData.strings.Common_Back))
