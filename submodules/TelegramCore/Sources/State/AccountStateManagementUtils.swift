        ...
        switch operation {
            ...
            case let .DeleteMessagesWithGlobalIds(ids):
                if SGSimpleSettings.shared.antiRecall {
                    ...
                    for globalId in ids {
                        let mapped = transaction.messageIdsForGlobalIds([globalId])
                        if let messageId = mapped.first {
            ...
            case let .EditMessage(id, message):
                ...
                transaction.updateMessage(id, update: { previousMessage in
                    if SGSimpleSettings.shared.keepEditHistory {
                        if !previousMessage.text.isEmpty && previousMessage.text != message.text {
                            SGAyugramStorage.shared.recordEdit(
